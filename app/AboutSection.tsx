...
export default function AboutSection() {
  return (
    <div className='relative overflow-hidden w-full flex flex-col items-center justify-center px-5 sm:px-20 py-[200px] bg-[var(--foreground)] text-[var(--background)]'>
        ...
        <Link href='/about' className='relative w-fit px-8 py-2 bg-[var(--background)] text-[var(--foreground)] text-2xl font-light border border-[var(--background)] hover:bg-transparent hover:text-[var(--background)] duration-300 mt-10'>About Us</Link>
    </div>
  )
}
