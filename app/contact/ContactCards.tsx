...
export default function ContactCards() {
  return (
    <div className='relative w-full px-5 md:px-[120px] mb-10 flex flex-wrap gap-[30px]'>
        <div className="flex-1 flex flex-wrap lg:flex-nowrap gap-10 py-10 px-7 md:px-14 bg-[var(--primary)] rounded-lg">
        ...
        <div className="flex-1 flex flex-wrap lg:flex-nowrap py-10 px-7 md:px-14 bg-[var(--primary)] rounded-lg">
            <div className="flex gap-5 sm:min-w-[300px] min-w-[200px] flex-wrap xl:flex-nowrap">
