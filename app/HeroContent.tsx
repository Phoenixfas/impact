...
export default function HeroContent() {
  ...
  return (
    <div className='hero-con relative w-full h-screen flex flex-col items-center sm:items-start justify-center px-5 sm:px-10 md:px-20 pt-20 sm:pb-20 overflow-hidden'>
        <h1 ref={heroH} className='hero-h relative max-w-[800px] text-[1.8rem] leading-[2.5rem] sm:text-5xl md:text-[4rem] md:leading-[5rem] lg:text-[5rem] lg:leading-[6rem] tracking-[1rem] text-center sm:text-left font-black mb-10 text-[var(--background)] uppercase drop-shadow-[0_0_5px_var(--background)] sm:font-outline-black  space-mono-bold'>Crafting Experiences <br /> Creating Impact</h1>
